...
export default function AnnouncementBanner() {
  const items = [
    "📲 FOR QUICK ORDERS & PRICE QUOTATION WHATSAPP: +91 98941 56149 / +91 63800 75118",
    "📞 DIRECT FACTORY CALLS: +91 78068 53112 / +91 84892 74614 / +91 94887 24240",
        ...
        {[...items, ...items].map((text, idx) => (
          <div key={idx} className="flex items-center gap-4 mx-6 shrink-0">
            ...
            >
              ...
              <span>WhatsApp: +91 98941 56149</span>
            </a>
          </div>
        ))}
      </div>
